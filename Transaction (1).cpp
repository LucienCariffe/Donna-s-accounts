...
{
    fromAccountNumber = fromAccountNumberIn;
    toAccountNumber = toAccountNumberIn;
    amount = amountIn;
}
//copy constructor
Transaction::Transaction(const Transaction & copy)
{
    fromAccountNumber = copy.fromAccountNumber;
    toAccountNumber = copy.toAccountNumber;
    amount = copy.amount;
}
//destructor
Transaction::~Transaction()
...
{
    cout << fromAccountNumber << " " << toAccountNumber << " " << amount << "\n";
}
//getters
